      ...
      <div>
        ...
        <div className="py-20 px-10 grid md:grid-cols-2 lg:grid-cols-4 gap-20 md:py-32 bg-black">
          {strategies.map((strategy, index) => (
            <div className="text-center hover:text-white hover:translate-y-1 text-white lg:text-opeqblue lg:transition-all lg:duration-500" key={index} data-aos = "fade-right">
